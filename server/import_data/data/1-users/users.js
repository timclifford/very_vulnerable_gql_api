...
const users = [
  ...
  },
  {
    ...
    {
    _id: new mongoose.Types.ObjectId("61058ea4d1bb361df4bcc684"),
    username: "dr-rose-byrne",
    display_name: "Dr. Rose Byrne",
    email: "dr.rose.byrne@general-practice-2.com",
    password: "$2b$10$EWbF4QF6pWjybTq1UUywe.d.KQ9X6Onhd/BLzM5//VWFhM9iH5q6i",
    practice: new mongoose.Types.ObjectId("61058e4bb81a2c86d3f81e61"),
    roles: ['user', 'doctor'],
    __v: 0
  ...
  {
    _id: new mongoose.Types.ObjectId("61058ecba911845167fd3154"),
    username: "paul-johnson",
    display_name: "Paul Johnson",
    email: "paul.johnson@general-practice-1.com",
    password: "$2b$10$EWbF4QF6pWjybTq1UUywe.d.KQ9X6Onhd/BLzM5//VWFhM9iH5q6i",
    practice: new mongoose.Types.ObjectId("61058f5a5a754efc48a889b4"),
    roles: ['user', 'receptionist'],
    __v: 0
