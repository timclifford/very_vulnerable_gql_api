          ...
          <table className="w-1/2">
            <tbody>
              ...
              <tr>
                ...
                <td className="border px-4 py-2">{p.sex}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border px-4 py-2">{p.weight}</td>
              </tr>
              <tr>
